...
```html
<!-- render:preview -->
<button data-action="accordion-set-value" data-value="donec" class="button">
  Set Donec
</button>
<button
...
This will initialize all elements with `class="accordion-js"` and add the necessary interaction behavior.
